...
const sendDB = (res: Response) => fullDB().then((db) => res.json(db))

app.get('/api/db', (_req: Request, res: Response) => sendDB(res))
...
app.post('/api/tasks/:taskId/accept', async (req: Request, res: Response) => {
...
app.post('/api/tasks/:taskId/messages', async (req: Request, res: Response) => {
...
app.post('/api/tasks/:taskId/reviews', async (req: Request, res: Response) => {
